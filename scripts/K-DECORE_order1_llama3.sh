...
# —— path —— #
DATA_ROOT="../data/KBQA_CL_2stages_order1_llama3"
...
SAVE_ROOT="../saves/KBQA_CL_2stages_order1_llama3/${MODEL_NAME}/seq_lora"
CFG_ROOT="../config/KBQA_CL_2stages_order1_llama3/${MODEL_NAME}/seq_lora"
...
pushd "${DATA_ROOT}/task1" >/dev/null && python grailqa_split_test.py   && popd >/dev/null
pushd "${DATA_ROOT}/task2" >/dev/null && python mtop_split_test.py     && popd >/dev/null
pushd "${DATA_ROOT}/task3" >/dev/null && python spider_split_test.py   && popd >/dev/null
pushd "${DATA_ROOT}/task4" >/dev/null && python compwebq_split_test.py && popd >/dev/null
