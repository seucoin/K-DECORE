...
# —— path —— #
DATA_ROOT="../data/KBQA_CL_2stages_order3_qwen2.5"
...
SAVE_ROOT="../saves/KBQA_CL_2stages_order3_qwen2.5/${MODEL_NAME}/seq_lora"
CFG_ROOT="../config/KBQA_CL_2stages_order3_qwen2.5/${MODEL_NAME}/seq_lora"
