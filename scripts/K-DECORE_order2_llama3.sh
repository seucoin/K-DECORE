...
# —— path —— #
DATA_ROOT="../data/KBQA_CL_2stages_order2_llama3"
...
SAVE_ROOT="../saves/KBQA_CL_2stages_order2_llama3/${MODEL_NAME}/seq_lora"
CFG_ROOT="../config/KBQA_CL_2stages_order2_llama3/${MODEL_NAME}/seq_lora"
